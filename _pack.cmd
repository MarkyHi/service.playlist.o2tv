...
%zip% a service.playlist.o2tv.zip ..\service.playlist.o2tv -r -x!repository.pavucina.info.bin -x!__pycache__ -x!*.pyc -x!.idea -x!.git -x!device_id -x!playlist.log -x!o2tv.generic.m3u8 -x!o2tv.playlist.m3u8 -x!streamer.sh*
